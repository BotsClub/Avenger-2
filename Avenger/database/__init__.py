...
from Avenger import MONGO_DB, MONGO_URI, LOGGER

try:
    avenger_db_client = MongoClient(MONGO_URI)
except PyMongoError as f:
    LOGGER.error(f"Error in Mongodb: {f}")
    exiter(1)
avenger_main_db = avenger_db_client[MONGO_DB]
...
class MongoDB:
    ...
    def __init__(self, collection) -> None:
        self.collection = avenger_main_db[collection]
    ...
    @staticmethod
    def close():
        return avenger_db_client.close()
