...
async def detect_nsfw(_, message):
    if await is_nsfw_on(message.chat.id):
        return
...
**————————————————————**
__Powered By @AvengerBot__.
"""
    )


@pbot.on_message(filters.command(["nsfwscan", f"nsfwscan@AvengerBot"]))
@capture_err
...
@pbot.on_message(
    filters.command(["antinsfw", f"antinsfw@AvengerBot"]) & ~filters.private
)
